...
export const CHECKOUT_URL = 'https://pay.hub.la/Zz63jDIBvO2oAfSvwFuF'
 ...
 *
 * PRIVACIDADE: só eventos de funil vão para a Meta. Nenhuma
 * resposta das perguntas marcadas como `sensitive` em
 * questions.js é enviada — nem como parâmetro custom.
 */
export const META_PIXEL_ID = '3473426646173543'
